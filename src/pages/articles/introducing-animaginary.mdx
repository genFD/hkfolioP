...
import Illustration from './plan-and-build-react-app/illustration.png'

export const meta = {
  author: 'Hermann Kanga',
  date: '2022-09-02',
  title: 'State Management : Redux and Redux toolkit',
  description:
...
State management solutions : Part 2 - Redux and Redux toolkit
...
export function MyComp({ open, children }) {
  return (
    <animate.div
      in={open}
